...
const isWindowPhone: boolean = /windows phone/i.test(ua)

interface DetectedInfos {
  isAndroid: boolean
  isIOS: boolean
...
const detectedInfos: DetectedInfos = {
